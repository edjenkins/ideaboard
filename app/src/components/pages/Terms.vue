<template lang="pug">
  #about
    page-header(title="Terms and Conditions" subtitle="Here are the terms that you should read through before using this site")
    .row
      .content-block.pull-up.white-block
        .content-block--body

          p Please read these terms of use carefully before using the services offered by University of Newcastle Upon Tyne (“Newcastle University”, "University of Newcastle Upon Tyne", “we”, “us”). These terms of use set forth the legally binding terms and conditions for your use of the website at {{ siteAddress }} (the "Service") and the services, features, content, applications or widgets offered by Newcastle University (collectively with the Service, the "Service").
          ...
          p 
            strong IF YOU DO NOT AGREE TO THESE TERMS OF SERVICE YOU MAY NOT ACCESS OR OTHERWISE USE OUR SITE.
          ...
          ol
            ...
            li solicits personal information from anyone under the age of 21 years;
            ...
            li solicits passwords from other users or personal identifying information for commercial or unlawful purposes from other users;
          ...
          p If you wish to report any Content or conduct on the Service that you believe is inappropriate, please contact us.

          p 
            strong NO CONTENT MONITORING.
          ...
          p The existence of a link between this Service and any other website is not and shall not be understood to be an endorsement by us of the owner or proprietor of the linked internet website, nor an endorsement of us by the owner or proprietor of such linked website.
          ...
          p Further, to the fullest extent permissible by law, we disclaim any express or implied warranties, including, without limitation, non-infringement, title, merchantability or fitness for a particular purpose.

          p We do not warrant that the functions contained in the Service or, materials or content contained therein will be completely secure, uninterrupted or error free, that defects will be corrected, or that the site or the server that makes it available is free of viruses or other harmful components.

          p We shall not be liable for the use of the Service, including, without limitation, the content and any errors contained therein provided by third parties.
          ...
          p 
          strong JURISDICTION AND GOVERNING LAW.
          ...
          strong EFFECTIVE DATE.
            | These Terms of Use were last updated on 28th July 2016.
