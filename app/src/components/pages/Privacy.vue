<template lang="pug">
  #about
    page-header(title="Privacy Policy" subtitle="Here is the privacy policy that you should read through before using this site")
    .row
      .content-block.pull-up.white-block
        .content-block--body

          p University of Newcastle Upon Tyne (“Newcastle University”, “we”, “us”), the owner of [{{ siteName }}], an online commissioning platform (the “Site”, or "Service"), recognizes the importance of your privacy. Therefore, we have created this Privacy Policy so that you know how we use and disclose your information when you make it available to us. This Privacy Policy applies solely to information collected at this Site. By using or accessing the Site, you signify your agreement to be bound by our Privacy Policy.

          p 
            strong IF YOU DO NOT AGREE TO THIS PRIVACY POLICY YOU MAY NOT ACCESS OR OTHERWISE USE OUR SITE.

          p 
            strong Personal Information that we collect:
            | We do not collect personal information from you unless you voluntarily provide it to us, such as when you register for the Site or submit a piece of content.

          p 
            strong Non-personal or Aggregate Information that we collect:
          ...
          p 
            strong Your Disclosure on the Site and in Social Media:
          ...
          p 
            strong Other Sites and Applications:
          ...
          p If you use any extra plug-ins or third party applications (“Applications”) in connection with the Site, the provider(s) of these Applications may obtain access to certain personal information about you. We do not and cannot control how the providers of Applications may use any personal information collected in connected with such Applications. Please be sure to review any privacy policies or other terms applicable to your use of these Applications prior to installation.
          ...
          p 
            strong Opt-Out Process:
            | If you do not want to receive email communications (including email digests) from us in the future, please send an email to us at <a target="_self" v-bind:href="`mailto:${siteContact}`">{{ siteContact }}</a> requesting to be removed from our mailing list. You will also have the option of clicking on a link included in email correspondence you receive from us in order to remove yourself from our mailing list.

          p If you do not want to want to receive our newsletters in the future, please send an email to us at <a target="_self" v-bind:href="`mailto:${siteContact}`">{{ siteContact }}</a> requesting to be removed from our mailing list. You will also have the option of clicking on a link included in the newsletters you receive from us in order to remove yourself from our mailing list.
          ...
          p Site Terms of Use: Use of this Site is governed by, and subject to, the Terms of Use. This Privacy Policy is incorporated into such terms. Your use, or access, of the Site constitutes your agreement to be bound by these provisions.

          p 
            strong IF YOU DO NOT AGREE TO THESE TERMS OF USE YOU MAY NOT ACCESS OR OTHERWISE USE THE SITE.

          p 
            strong Transfers of Personal Data Outside the EEA:
            | The personal data that we collect from you may be transferred to, and stored at, a destination outside the European Economic Area ("EEA"). It may also be processed by staff operating outside the EEA who work for us or for one of our suppliers. By submitting your personal data, you agree to this transfer, storing or processing. We will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this privacy policy.

          p 
            strong Contact:
            | For questions or concerns relating to privacy, we can be contacted at: <a target="_self" v-bind:href="`mailto:${siteContact}`">{{ siteContact }}</a>.

          p 
            strong EFFECTIVE DATE.
            | This Privacy Policy was last updated on 28th July 2016.
